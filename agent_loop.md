...
An AI agent doesn't just make one guess and stop. It works in a loop, constantly
checking whether its actions are working and adjusting if they aren't. This loop
has five steps:
